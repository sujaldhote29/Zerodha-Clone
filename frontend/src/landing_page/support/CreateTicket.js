    ...
    return (
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}><i class="fa fa-plus-circle" aria-hidden="true"></i>  Account Opening</a>
                    </h4>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account </a>
                    </h4>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}> <i class="fa fa-bar-chart" aria-hidden="true"></i>  Trading and Markets </a>
                    </h4>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}> <i class="fa fa-credit-card" aria-hidden="true"></i>  Funds </a>
                    </h4>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}>  <i class="fa fa-plus-circle" aria-hidden="true"></i>  Console  </a>
                    </h4>
                ...
                <div className='col-4 mt-2 p-5 mb-2'>
                    <h4 className='fs-5 text-muted'>
                        <a href='' style={{ textDecoration: "none", color: "#666666", }}>   <i class="fa fa-plus-circle" aria-hidden="true"></i>  Coin </a>
                    </h4>
