...
function ProductsPage() {
    return (
        <>
            ...
            <p className='text-center fs-4'>Want to know more about our technology stack? Check out the <a href='https://zerodha.tech/' style={{textDecoration:"none"}}>Zerodha.tech</a> blog.</p>
